...
<head>
    ...
    <style>
        body {
            background: linear-gradient(120deg, #84fab0, #8fd3f4); /* Soft gradient colors */
            min-height: 100vh;
            display: flex;
            align-items: center;
...
<body>
    <div class="container my-3" style="background-color: rgba(255, 255, 255, 0.8); border-radius: 15px; box-shadow: 0 4px 10px rgba(0, 0, 0, 0.2);">
        <div class="row d-flex justify-content-center">
            <div class="col-6">
                <img src="sigma.png" alt="" width="100px" class="d-block mx-auto">
                <h2 class="text-center">FORM PENDAFTARAN BERGABUNG DENGAN SIGMA</h2>
            </div>
        </div>
        <div class="row d-flex justify-content-center">
            <div class="col-6 shadow-lg py-3 rounded">
                <form name="registrationForm" action="process.php" method="POST" enctype="multipart/form-data" onsubmit="validateForm(event)" class="mt-5">
                    ...
                    <button type="submit" class="btn btn-primary w-50 d-flex justify-content-center mx-auto" style="background-color: #6C757D;">Submit</button>
                </form>
            </div>
        </div>
    </div>
