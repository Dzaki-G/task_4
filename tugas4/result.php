    ...
    <div class="container my-3">
        ...
        <div class="row">
            <div class="col-12">
                ...
                <table class="table table-striped mt-2">
                    <tr>
                        <th class="table-info" style="background-color: #D6D7D9;">Isi</th>
                    </tr>
                    <?php foreach ($data['fileContent'] as $line): ?>
                    <tr>
                        <td style="min-height: 20px; line-height: 20px;"><?= htmlspecialchars($line) ?></td>
                    </tr>
                    <?php endforeach; ?>
                </table>
            </div>
                <a href="index.php" class="btn btn-secondary py-1 w-50 d-flex justify-content-center mx-auto mt-2">Back</a>
        </div>
    </div>
</body>
</html>